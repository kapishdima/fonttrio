...
export function AuthDivider() {
	return (
		<div className="relative my-6">
			...
			<span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 px-3 text-xs dark:text-neutral-600 text-neutral-400 dark:bg-neutral-950 bg-white">
				or
			</span>
		</div>
	);
