          ...
          <AnimatedLayout>
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed max-w-md">
                Browse {pairings.length}+ curated font pairings. Three fonts, one command.
              </p>
            </div>
          </AnimatedLayout>
        </div>
      ...
      <main className="px-0">
        {filteredPairings.length === 0 ? (
          <div className="px-4 lg:px-8 py-24 text-center">
            <p className="text-muted-foreground text-sm">No pairings match the current filters.</p>
          </div>
        ) : (
  ...
  return (
    <NuqsAdapter>
      <Suspense fallback={null}>
        <PairingsClientInner pairings={pairings} />
      </Suspense>
    </NuqsAdapter>
  );
}
