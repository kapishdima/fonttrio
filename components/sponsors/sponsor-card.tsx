...
export function SponsorCard({
	...
	return (
		<a
			...
			className={`group flex items-center justify-center px-6 ${cellPy} border-b border-r dark:border-neutral-800 border-neutral-200 last:border-b-0 dark:hover:bg-neutral-900/60 hover:bg-neutral-50 transition-colors`}
		>
